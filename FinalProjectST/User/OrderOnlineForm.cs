...
{
    public partial class OrderOnlineForm : Form
    {
        public OrderOnlineForm()
        {
            InitializeComponent();
        }
            ...
            if (flag == 1)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        else if (ORDER.addOnlineOrder(oid, fid, amount))
                        {
                            LoadOrdered();
                            ClearAllLabel();
                            TotalAll();
            ...
            if (flag == 2)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        else if (ORDER.updateOnlineOrder(oid, fid, newAmount))
                        {
                            oldAmount = newAmount;
                            LoadOrdered();
                            TotalAll();
            ...
            if (flag == 2)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        else if (ORDER.removeOnlineOrder(oid, fid))
                        {
                            oldAmount = 0;
                            LoadOrdered();
                            ClearAllLabel();
